...
sig   = *:64:mss*20,10:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*20,7:mss,sok,ts,nop,ws:df,id+
...
sig   = *:64:mss*4,6:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*4,7:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*4,8:mss,sok,ts,nop,ws:df,id+

label = s:unix:Linux:2.4.x
sig   = *:64:mss*4,0:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*4,1:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*4,2:mss,sok,ts,nop,ws:df,id+

; No real traffic seen for 2.2 & 2.0, signatures extrapolated from p0f2 data:

label = s:unix:Linux:2.2.x
sig   = *:64:mss*11,0:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*20,0:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*22,0:mss,sok,ts,nop,ws:df,id+
...
sig   = *:64:mss*44,1:mss,sok,ts,nop,ws:df,id+
sig   = *:64:mss*44,3:mss,sok,ts,nop,ws:df,id+

; Catch-all rules:

label = g:unix:Linux:3.x
sig   = *:64:mss*10,*:mss,sok,ts,nop,ws:df,id+

label = g:unix:Linux:2.4.x-2.6.x
sig   = *:64:mss*4,*:mss,sok,ts,nop,ws:df,id+

label = g:unix:Linux:2.2.x-3.x
sig   = *:64:*,*:mss,sok,ts,nop,ws:df,id+

label = g:unix:Linux:2.2.x-3.x (no timestamps)
sig   = *:64:*,*:mss,nop,nop,sok,nop,ws:df,id+
